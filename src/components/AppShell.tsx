...
export async function AppShell({children}:{children:React.ReactNode}){
  ...
  return <div>
    <header className="topbar">
      ...
      <Link className="help-link" href="/ajuda" aria-label="Precisa de ajuda?" title="Precisa de ajuda?"><span className="help-icon">?</span><span className="help-text">Precisa de ajuda?</span></Link>
