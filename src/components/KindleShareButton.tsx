...
export function KindleShareButton({id,title,author="",source="user"}:{id:string;title:string;author?:string;source?:"user"|"catalog"}){
  ...
  async function prepareFile(coverUrl:string){
    ...
    try{
      ...
      setPreparedFile(file);setPicker(false);setMessage("EPUB pronto com a capa escolhida.");
