...
export function SiteFooter({categories}:{categories:Category[]}){
  ...
  return <footer className="site-footer">
    <div className="shell-width footer-main">
      <div className="footer-brand"><img src="/kindle-books-logo-footer.svg" alt="KINDLE BOOKS"/><p>Seu acervo de eBooks em PDF e EPUB para baixar e ler no app que preferir.</p></div>
    ...
    <div className="footer-bottom"><div className="shell-width"><span>© {year} KINDLE BOOKS.</span><span>Acervo independente. Não afiliado à Amazon ou à marca Kindle.</span></div></div>
  </footer>;
}
