...
export function SiteFooter({categories}:{categories:Category[]}){
  ...
  return <footer className="site-footer">
    <div className="shell-width footer-main">
      <div className="footer-brand"><img src="/kindle-books-logo.svg" alt="KINDLE BOOKS"/><p>Seu acervo de eBooks em PDF e EPUB para baixar e ler no app que preferir.</p></div>
