...
export const metadata: Metadata = {
  title: "Política de Privacidade | Estante Virtual",
  description: "Política de Privacidade da Estante Virtual."
};
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0b1020", color: "#f8fafc", padding: "48px 20px" }}>
      <article style={{ maxWidth: 860, margin: "0 auto", background: "#111827", border: "1px solid #263246", borderRadius: 24, padding: "32px", lineHeight: 1.7 }}>
        ...
        <p>A Estante Virtual é um serviço privado de organização e distribuição de livros digitais. Esta política explica quais dados podem ser tratados pelo aplicativo e como eles são utilizados.</p>
        ...
        <p>O acesso ao Google Drive é usado somente para as funcionalidades da Estante Virtual. Os dados obtidos pelas APIs do Google não são vendidos nem utilizados para publicidade.</p>
        ...
        <p>Os dados são mantidos enquanto forem necessários para prestar o serviço. Usuários podem solicitar a remoção de dados associados à sua conta ao administrador da Estante Virtual.</p>

        <h2>8. Revogação do acesso ao Google</h2>
        <p>O administrador pode revogar o acesso da Estante Virtual à conta Google a qualquer momento nas configurações de segurança da própria Conta Google. A revogação impede novos acessos ao Drive até que a conta seja conectada novamente.</p>

        <h2>9. Contato</h2>
        <p>Para dúvidas, solicitações de privacidade ou exclusão de dados, utilize o e-mail de suporte informado na tela de consentimento OAuth da Estante Virtual.</p>
